...
const GameScreen = ({ roomId, playerId, playerRole, onLeaveRoom }) => {
  ...
  // Xóa phòng sau 5s khi game kết thúc
  useEffect(() => {
  ...
  // Xử lý chọn nhanh nhân vật (nhấn giữ 2s hoặc click chuột phải)
      ...
      <div className="max-w-7xl mx-auto mb-6">
        <div className="bg-white rounded-xl shadow-lg p-4">
          <div className="flex justify-between items-center mb-2">
            ...
            >
              {isDeleting ? "Đang xóa..." : "Thoát phòng"}
            </button>
          </div>
      ...
      <div className="max-w-7xl mx-auto mt-6">
        <div className="bg-yellow-100 border-l-4 border-yellow-500 p-4 rounded">
          <p className="text-sm text-yellow-800">
            ...
            mờ). Click lần 2 để hiện lại. <strong className="text-red-700">Nhấn giữ 2s hoặc click chuột phải</strong> vào nhân vật để chọn nhanh (đoán luôn nhân vật đó). Hãy đặt câu hỏi và loại trừ các nhân
